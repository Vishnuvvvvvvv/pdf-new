...
class PPDocLayoutV2ForObjectDetection(RTDetrForObjectDetection):
    ...
    def __init__(self, config: PPDocLayoutV2Config):
        ...
        self.model.decoder.class_embed = old_model.decoder.class_embed
        self.model.decoder.bbox_embed = old_model.decoder.bbox_embed
    ...
    def forward(
        ...
        **kwargs,
        ...
        class_thresholds_tensor = torch.tensor(self.config.class_thresholds, dtype=torch.float32, device=logits.device)
        thresholds = class_thresholds_tensor[class_ids]
        ...
        class_order_tensor = torch.tensor(self.config.class_order, dtype=torch.long, device=logits.device)
        pad_class_ids = class_order_tensor[pad_class_ids]
